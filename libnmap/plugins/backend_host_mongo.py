...
class NmapMongodbPlugin(NmapBackendPlugin):
    ...
    class Reports():
        def __init__(self, obj_NmapReport):
            ...
            open_ports = obj_NmapReport.get_open_ports()
                
            self.dic_report = {'inserted': inserted, 'taskid': taskid, 'is_up': is_up, 'domain': domain,
                               'ip': address, 'os': os, 'open_ports': open_ports}
